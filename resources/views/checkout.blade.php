...
<div class="container">
  <main>
    ...
    <div class="py-3 text-left">
      <a class="text-decoration-none" href="/"><p>Back to Cart</p></a>
    </div>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          ...
          <div class="my-3">
            <div class="form-check">
              <input id="Qris" name="paymentMethod" type="radio" class="form-check-input" checked required>
              <label class="form-check-label" for="Qris">Qris</label>
            </div>
            <div class="form-check">
              <input id="Gopay" name="paymentMethod" type="radio" class="form-check-input" required>
              <label class="form-check-label" for="Gopay">Gopay</label>
            </div>
            <div class="form-check">
              <input id="Shopeepay" name="paymentMethod" type="radio" class="form-check-input" required>
