...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Create New Content</h1>
</div>
<a href="/dashboard/contents" class="btn btn-success mb-3"><span data-feather="arrow-left"></span>Back to all my contents</a>

<div class="col-lg-8">
    <form method="post" action="/dashboard/contents" enctype="multipart/form-data"> 
        @csrf
        <div class="mb-3">
